			...
			<div class="foods-wrapper" ref="foodswrapper">
				<ul> 
					<li class="food-list food-list-hook" v-for="item in goods" :key="item.key">
						...
						<ul>
							<li v-for="food in item.foods" :key="food.key" class="food-item border-1px" @click="selectFood(food,$event)">
								<div class="icon">
								...
								<div class="content">
									...
									<div class="extra">
										<span class="count">月售{{food.sellCount}}份</span><span>好评率{{food.rating || '0'}}%</span>
									</div>
									<div class="price">
