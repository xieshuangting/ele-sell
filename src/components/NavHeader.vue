					...
					.supports
						...
						.support-item
							...
							.icon
								...
								background-repeat: no-repeat
								&.decrease
									bg-image('../../static/image/decrease_2')
								&.discount
									bg-image('../../static/image/discount_2')
								&.guarantee
									bg-image('../../static/image/guarantee_2')
								&.invoice
									bg-image('../../static/image/invoice_2')
								&.special
									bg-image('../../static/image/special_2')
							.text
								line-height: 16px
								font-size: 12px
					.bulletin
